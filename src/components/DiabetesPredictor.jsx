      ...
      <div className="predictor-card">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-primary-800 mb-2 flex items-center justify-center">
            ...
            <span className="material-symbols-outlined ml-2 text-primary-600">
              monitoring
            </span>
          </h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Enter your health information below to assess your diabetes risk.
          </p>
        </div>
        ...
        <div className="form-container">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="mt-8 text-center button-group">
              <button 
              ...
              >
                Reset
                <span className="material-symbols-outlined ml-2">refresh</span>
              </button>
            </div>
          </form>
        </div>
